...
public class MenuChoixDuJeu {
    ...
    public MenuChoixDuJeu(Stage stage) {
        ...
        imageJeu1 = new ImageView(new Image(new File("./data/Logos/cassebriquemenuchoixdujeu.jpg").toURI().toString()));
        ...
        imageJeu2 = new ImageView(new Image(new File("./data/Logos/pacmanmenuchoixdujeu.jpg").toURI().toString()));
